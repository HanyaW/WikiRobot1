...
WIKI_IMG = "https://telegra.ph/file/6d3e3ef24f64fb6e35df0.jpg"
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "about_button"), callback_data="wiki_"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                        ...
                        [
                            InlineKeyboardButton(
                                ...
                                url="t.me/wikixbot?startgroup=new",
                            ),
                        ],
                    ]
                ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text=gs(chat.id, "notes_button"), callback_data="wiki_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "support_chat_link_button"),
                            callback_data="wiki_support",
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://github.com/shiinobu/WikiRobot",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "back_button"), callback_data="wiki_back"
                        ),
                    ],
                ]
            ),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "back_button"), callback_data="wiki_"
                        ),
                    ]
                ]
            ),
