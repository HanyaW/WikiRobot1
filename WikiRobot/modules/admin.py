...
❂ /pin*:* diam-diam menyematkan pesan yang dibalas - add `'loud'` or `'notify'` untuk memberikan pemberitahuan kepada pengguna
...
❂ /purge <integer X>*:* menghapus pesan yang dibalas, dan pesan X yang mengikutinya jika membalas pesan.
...
❂ /setrules <your rules here>*:* tetapkan aturan untuk obrolan ini.
